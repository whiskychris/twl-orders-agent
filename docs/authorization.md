...
| `order_entry` | `find_company`, `find_variant`, `prepare_draft_order` | preparing a draft order. Allowed in a DM and in `order_entry_channels` only. Approval and creation are separate (`docs/order-entry.md`) |
